...
###############################################################################
# change ice effects on breeding propensity
...
change.betaBP <- jags(jags.data, inits, parameters, "YKD_IPM.jags", 
                      n.chains = nc, n.burnin=nb, n.iter = ni,  
                      parallel = TRUE, n.adapt = 1000)
saveRDS(change.betaBP, file = "MS_Scenarios/change.betaBP.rds")

###############################################################################
# change obs error specification
cat(file = "YKD_IPM.jags", "
model {
...
parameters <- c("Nb", "phiA", "phi0", "F", "mean.phi0", "mean.phiA", "alpha", 
                ...
                "betaF.ice", "betaF.ice2", "betaF.ice3", "mean.logit.BP")

change.d <- jags(jags.data, inits, parameters, "YKD_IPM.jags", 
                      n.chains = nc, n.burnin=nb, n.iter = ni,  
                      parallel = TRUE, n.adapt = 1000)

saveRDS(change.d, file = "MS_Scenarios/change.d.rds")
...
change.DD <- jags(jags.data, inits, parameters, "YKD_IPM.jags", 
                 n.chains = nc, n.burnin=nb, n.iter = ni,  
                 parallel = TRUE, n.adapt = 1000)
saveRDS(change.DD, file = "MS_Scenarios/change.DD.rds")
